...
public class ReflectionQtHelper {
    ...
    public int getModeOfQuestionType(int questionTypeCode, Activity activity) {
        ...
        try {
            questionTypeMode = Class.forName("hr.air.interactiveppt.questiontype." + activity.getResources().getStringArray(R.array.questionTypesClassNames)[questionTypeCode-1]).getField("mode").getInt(null);
        }
        catch (Exception e) {
    ...
    public QuestionTypeControl instatiateControl(int questionTypeCode, Activity activity, Object ... objects) {
        ...
        try {
            Class<?> cl = Class.forName("hr.air.interactiveppt.questiontype." + activity.getResources().getStringArray(R.array.questionTypesClassNames)[questionTypeCode-1]);
            Constructor<?> cons;
