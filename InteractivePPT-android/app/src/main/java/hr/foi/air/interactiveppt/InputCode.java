                ...
                new SendDataAndProcessResponseTask.PostActions() {
                    ...
                    public void onSuccess(Object genericResponse) {
                        ...
                        if (response != null) {
                            ...
                            findViewById(R.id.activity_input_code).setClickable(true);
                            findViewById(R.id.loading_panel).setVisibility(View.GONE);
                            Toast.makeText(InputCode.this, R.string.no_ppt_with_corresponding_code_error, Toast.LENGTH_LONG).show();
                        }
                    }
                    ...
                    public void onFailure() {
                        findViewById(R.id.activity_input_code).setClickable(true);
                        findViewById(R.id.loading_panel).setVisibility(View.GONE);
                        Toast.makeText(InputCode.this, R.string.presentation_fetch_error, Toast.LENGTH_LONG).show();
                    }
                }
        );
    }
