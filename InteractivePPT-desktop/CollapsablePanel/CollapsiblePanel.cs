...
{
    /// <summary>
    /// By Mokdes Hamid (source: https://www.codeproject.com/Articles/53318/C-Custom-Control-Featuring-a-Collapsible-Panel )
    /// </summary>
    ...
    public partial class CollapsiblePanel : Panel
    {
        ...
        [Category("CollapsiblePanel")]
        [Description("Height of panel's header.")]
        ...
        private void RedrawParentControl()
        {
            ...
            form.Size = new Size(form.Width, form.Height + 1);  // resizing of form causes redrawing its controls
            form.Size = new Size(form.Width, form.Height - 1);
        }
        ...
        private void pictureBoxExpandCollapse_MouseMove(object sender, MouseEventArgs e)
        {
            if (!timerAnimation.Enabled)
            {
                if (!collapse)
                {
                    pictureBoxExpandCollapse.Image = Resources.collapse_highlight;
                }
                else
